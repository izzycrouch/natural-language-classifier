...
6. Run 'python3 train_layer/train_random_forest_model.py' to train classifier model.
7. Run 'pytest tests/test_emotion_classifier' to check that EmotionClassifier class passes tests.
8. Run 'python3 classifier_layer/simple_interface.py' to predict emotions through the CLI.
